...
from src.prism.exceptions import MilvusConnectionError, CollectionNotFoundError, VectorInsertionError
...
"""
class MilvusClient:
    def __init__(self, collection_name="PrismCollection", host="localhost", port="19530"):
        ...
        try:
            ...
            raise MilvusConnectionError(f"Failed to connect to Milvus at {host}:{port}", original_error=e)
    ...
    def insert(self, frame_id: int, timestamp: float, vector: list):
        ...
        try:
            ...
            raise VectorInsertionError(f"Failed to insert frame {frame_id}", original_error=e)
